...
class DWANode:
    ...
    def visualize_states(self):
        ...
        marker = Marker()
        marker.header.frame_id = "map"#self.world_frame  # Marker's reference frame
    ...
    def visualize_trajectories(self):
        ...
        marker_msg.header.frame_id = "map"#self.current_gridmap.header.frame_id  # Specify the frame ID
