...
class OnlinePlanner:
    ...
    def get_gridmap(self, gridmap):
        # print("Received new gridmap")
        # print("Gridmap timestamp: ", gridmap.header.stamp)
        # print("Last map time: ", self.last_map_time)
...
if __name__ == '__main__':
    ...
    node = OnlinePlanner('/map', '/odom', '/cmd_vel', [-10.0, 10.0, -10.0, 10.0], 0.2)
